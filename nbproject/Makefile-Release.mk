...
${OBJECTDIR}/_ext/1fd4b5f3/alarms.o: /media/Data/Logic/alarms.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1fd4b5f3/alarms.o /media/Data/Logic/alarms.cpp

${OBJECTDIR}/_ext/1fd4b5f3/automatic.o: /media/Data/Logic/automatic.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/1fd4b5f3
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1fd4b5f3/automatic.o /media/Data/Logic/automatic.cpp

${OBJECTDIR}/_ext/1fd4b5f3/checks.o: /media/Data/Logic/checks.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/1fd4b5f3
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1fd4b5f3/checks.o /media/Data/Logic/checks.cpp

${OBJECTDIR}/_ext/1fd4b5f3/emergency.o: /media/Data/Logic/emergency.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/1fd4b5f3
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1fd4b5f3/emergency.o /media/Data/Logic/emergency.cpp

${OBJECTDIR}/_ext/1fd4b5f3/init.o: /media/Data/Logic/init.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/1fd4b5f3
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1fd4b5f3/init.o /media/Data/Logic/init.cpp

${OBJECTDIR}/_ext/1fd4b5f3/logic_precomp.o: /media/Data/Logic/logic_precomp.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/1fd4b5f3
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1fd4b5f3/logic_precomp.o /media/Data/Logic/logic_precomp.cpp

${OBJECTDIR}/_ext/1fd4b5f3/login.o: /media/Data/Logic/login.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/1fd4b5f3
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1fd4b5f3/login.o /media/Data/Logic/login.cpp

${OBJECTDIR}/_ext/1fd4b5f3/main.o: /media/Data/Logic/main.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/1fd4b5f3
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1fd4b5f3/main.o /media/Data/Logic/main.cpp

${OBJECTDIR}/_ext/1fd4b5f3/manual.o: /media/Data/Logic/manual.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/1fd4b5f3
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1fd4b5f3/manual.o /media/Data/Logic/manual.cpp

${OBJECTDIR}/_ext/1fd4b5f3/preform_registry.o: /media/Data/Logic/preform_registry.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/1fd4b5f3
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1fd4b5f3/preform_registry.o /media/Data/Logic/preform_registry.cpp

${OBJECTDIR}/_ext/1fd4b5f3/recovering.o: /media/Data/Logic/recovering.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/1fd4b5f3
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1fd4b5f3/recovering.o /media/Data/Logic/recovering.cpp

${OBJECTDIR}/_ext/1fd4b5f3/simulate.o: /media/Data/Logic/simulate.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/1fd4b5f3
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1fd4b5f3/simulate.o /media/Data/Logic/simulate.cpp

${OBJECTDIR}/_ext/1fd4b5f3/track.o: /media/Data/Logic/track.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/1fd4b5f3
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1fd4b5f3/track.o /media/Data/Logic/track.cpp

${OBJECTDIR}/_ext/1fd4b5f3/ui-io.o: /media/Data/Logic/ui-io.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/1fd4b5f3
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1fd4b5f3/ui-io.o /media/Data/Logic/ui-io.cpp
