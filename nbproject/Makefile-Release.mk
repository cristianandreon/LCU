...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lcu: ${OBJECTFILES}
	...
	g++ -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lcu ${OBJECTFILES} ${LDLIBSOPTIONS} -lpthread
...
${OBJECTDIR}/_ext/bef1c5b7/canbusCommands.o: /media/Data/COMM/canbusCommands.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/bef1c5b7
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/bef1c5b7/canbusCommands.o /media/Data/COMM/canbusCommands.cpp
...
${OBJECTDIR}/_ext/bef1c5b7/dataExchangeCAN.o: /media/Data/COMM/dataExchangeCAN.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/bef1c5b7
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/bef1c5b7/dataExchangeCAN.o /media/Data/COMM/dataExchangeCAN.cpp

${OBJECTDIR}/_ext/bef1c5b7/dataExchangeIO.o: /media/Data/COMM/dataExchangeIO.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/bef1c5b7
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/bef1c5b7/dataExchangeIO.o /media/Data/COMM/dataExchangeIO.cpp

${OBJECTDIR}/_ext/bef1c5b7/dataExchangeSCR.o: /media/Data/COMM/dataExchangeSCR.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/bef1c5b7
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/bef1c5b7/dataExchangeSCR.o /media/Data/COMM/dataExchangeSCR.cpp

${OBJECTDIR}/_ext/bef1c5b7/dataExchangeSER.o: /media/Data/COMM/dataExchangeSER.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/bef1c5b7
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/bef1c5b7/dataExchangeSER.o /media/Data/COMM/dataExchangeSER.cpp

${OBJECTDIR}/_ext/bef1c5b7/dataExchangeUSB-workinprogress.o: /media/Data/COMM/dataExchangeUSB-workinprogress.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/bef1c5b7
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/bef1c5b7/dataExchangeUSB-workinprogress.o /media/Data/COMM/dataExchangeUSB-workinprogress.cpp

${OBJECTDIR}/_ext/bef1c5b7/modbusCommands.o: /media/Data/COMM/modbusCommands.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/bef1c5b7
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/bef1c5b7/modbusCommands.o /media/Data/COMM/modbusCommands.cpp
...
${OBJECTDIR}/_ext/1fc5adf3/alarms.o: /media/Data/LOGIC/alarms.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1fc5adf3/alarms.o /media/Data/LOGIC/alarms.cpp

${OBJECTDIR}/_ext/1fc5adf3/login.o: /media/Data/LOGIC/login.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/1fc5adf3
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1fc5adf3/login.o /media/Data/LOGIC/login.cpp

${OBJECTDIR}/_ext/1fc5adf3/main.o: /media/Data/LOGIC/main.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/1fc5adf3
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1fc5adf3/main.o /media/Data/LOGIC/main.cpp

${OBJECTDIR}/_ext/1fc5adf3/simulate.o: /media/Data/LOGIC/simulate.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/1fc5adf3
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1fc5adf3/simulate.o /media/Data/LOGIC/simulate.cpp

${OBJECTDIR}/_ext/1fc5adf3/track.o: /media/Data/LOGIC/track.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/1fc5adf3
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1fc5adf3/track.o /media/Data/LOGIC/track.cpp
...
${OBJECTDIR}/_ext/89687c84/utility.o: /media/Data/RTLinux/Utility/utility.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/89687c84/utility.o /media/Data/RTLinux/Utility/utility.c

${OBJECTDIR}/_ext/2888cb1d/grammar.o: /media/Data/libconfig-1.5/lib/grammar.c
	${MKDIR} -p ${OBJECTDIR}/_ext/2888cb1d
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/2888cb1d/grammar.o /media/Data/libconfig-1.5/lib/grammar.c

${OBJECTDIR}/_ext/2888cb1d/libconfig.o: /media/Data/libconfig-1.5/lib/libconfig.c
	${MKDIR} -p ${OBJECTDIR}/_ext/2888cb1d
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/2888cb1d/libconfig.o /media/Data/libconfig-1.5/lib/libconfig.c

${OBJECTDIR}/_ext/2888cb1d/persistManager.o: /media/Data/libconfig-1.5/lib/persistManager.c
	${MKDIR} -p ${OBJECTDIR}/_ext/2888cb1d
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/2888cb1d/persistManager.o /media/Data/libconfig-1.5/lib/persistManager.c

${OBJECTDIR}/_ext/2888cb1d/scanctx.o: /media/Data/libconfig-1.5/lib/scanctx.c
	${MKDIR} -p ${OBJECTDIR}/_ext/2888cb1d
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/2888cb1d/scanctx.o /media/Data/libconfig-1.5/lib/scanctx.c

${OBJECTDIR}/_ext/2888cb1d/scanner.o: /media/Data/libconfig-1.5/lib/scanner.c
	${MKDIR} -p ${OBJECTDIR}/_ext/2888cb1d
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/2888cb1d/scanner.o /media/Data/libconfig-1.5/lib/scanner.c

${OBJECTDIR}/_ext/2888cb1d/strbuf.o: /media/Data/libconfig-1.5/lib/strbuf.c
	${MKDIR} -p ${OBJECTDIR}/_ext/2888cb1d
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/2888cb1d/strbuf.o /media/Data/libconfig-1.5/lib/strbuf.c

${OBJECTDIR}/_ext/13972e7c/modbus-data.o: /media/Data/libmodbus-3.1.4/src/modbus-data.c
	${MKDIR} -p ${OBJECTDIR}/_ext/13972e7c
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/13972e7c/modbus-data.o /media/Data/libmodbus-3.1.4/src/modbus-data.c

${OBJECTDIR}/_ext/13972e7c/modbus-rtu.o: /media/Data/libmodbus-3.1.4/src/modbus-rtu.c
	${MKDIR} -p ${OBJECTDIR}/_ext/13972e7c
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/13972e7c/modbus-rtu.o /media/Data/libmodbus-3.1.4/src/modbus-rtu.c

${OBJECTDIR}/_ext/13972e7c/modbus-tcp.o: /media/Data/libmodbus-3.1.4/src/modbus-tcp.c
	${MKDIR} -p ${OBJECTDIR}/_ext/13972e7c
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/13972e7c/modbus-tcp.o /media/Data/libmodbus-3.1.4/src/modbus-tcp.c

${OBJECTDIR}/_ext/13972e7c/modbus.o: /media/Data/libmodbus-3.1.4/src/modbus.c
	${MKDIR} -p ${OBJECTDIR}/_ext/13972e7c
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/13972e7c/modbus.o /media/Data/libmodbus-3.1.4/src/modbus.c

${OBJECTDIR}/_ext/8c2bd3e9/automatic.o: /media/Data/xBM-Logic/automatic.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/8c2bd3e9
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8c2bd3e9/automatic.o /media/Data/xBM-Logic/automatic.cpp

${OBJECTDIR}/_ext/8c2bd3e9/checks.o: /media/Data/xBM-Logic/checks.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/8c2bd3e9
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8c2bd3e9/checks.o /media/Data/xBM-Logic/checks.cpp

${OBJECTDIR}/_ext/8c2bd3e9/emergency.o: /media/Data/xBM-Logic/emergency.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/8c2bd3e9
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8c2bd3e9/emergency.o /media/Data/xBM-Logic/emergency.cpp

${OBJECTDIR}/_ext/8c2bd3e9/init.o: /media/Data/xBM-Logic/init.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/8c2bd3e9
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8c2bd3e9/init.o /media/Data/xBM-Logic/init.cpp

${OBJECTDIR}/_ext/8c2bd3e9/logic_precomp.o: /media/Data/xBM-Logic/logic_precomp.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/8c2bd3e9
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8c2bd3e9/logic_precomp.o /media/Data/xBM-Logic/logic_precomp.cpp

${OBJECTDIR}/_ext/8c2bd3e9/manual.o: /media/Data/xBM-Logic/manual.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/8c2bd3e9
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8c2bd3e9/manual.o /media/Data/xBM-Logic/manual.cpp

${OBJECTDIR}/_ext/8c2bd3e9/preform_registry.o: /media/Data/xBM-Logic/preform_registry.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/8c2bd3e9
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8c2bd3e9/preform_registry.o /media/Data/xBM-Logic/preform_registry.cpp

${OBJECTDIR}/_ext/8c2bd3e9/recovering.o: /media/Data/xBM-Logic/recovering.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/8c2bd3e9
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8c2bd3e9/recovering.o /media/Data/xBM-Logic/recovering.cpp

${OBJECTDIR}/_ext/8c2bd3e9/safety.o: /media/Data/xBM-Logic/safety.c
	${MKDIR} -p ${OBJECTDIR}/_ext/8c2bd3e9
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8c2bd3e9/safety.o /media/Data/xBM-Logic/safety.c

${OBJECTDIR}/_ext/8c2bd3e9/ui-io.o: /media/Data/xBM-Logic/ui-io.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/8c2bd3e9
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8c2bd3e9/ui-io.o /media/Data/xBM-Logic/ui-io.cpp

${OBJECTDIR}/_ext/4a6d875c/automatic.o: /media/Data/xCNC-Logic/automatic.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/4a6d875c
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4a6d875c/automatic.o /media/Data/xCNC-Logic/automatic.cpp

${OBJECTDIR}/_ext/4a6d875c/emergency.o: /media/Data/xCNC-Logic/emergency.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/4a6d875c
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4a6d875c/emergency.o /media/Data/xCNC-Logic/emergency.cpp

${OBJECTDIR}/_ext/4a6d875c/gcode.o: /media/Data/xCNC-Logic/gcode.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/4a6d875c
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4a6d875c/gcode.o /media/Data/xCNC-Logic/gcode.cpp

${OBJECTDIR}/_ext/4a6d875c/init.o: /media/Data/xCNC-Logic/init.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/4a6d875c
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4a6d875c/init.o /media/Data/xCNC-Logic/init.cpp

${OBJECTDIR}/_ext/4a6d875c/logic_precomp.o: /media/Data/xCNC-Logic/logic_precomp.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/4a6d875c
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4a6d875c/logic_precomp.o /media/Data/xCNC-Logic/logic_precomp.cpp

${OBJECTDIR}/_ext/4a6d875c/manual.o: /media/Data/xCNC-Logic/manual.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/4a6d875c
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4a6d875c/manual.o /media/Data/xCNC-Logic/manual.cpp

${OBJECTDIR}/_ext/4a6d875c/mill_utility.o: /media/Data/xCNC-Logic/mill_utility.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/4a6d875c
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4a6d875c/mill_utility.o /media/Data/xCNC-Logic/mill_utility.cpp

${OBJECTDIR}/_ext/4a6d875c/recovering.o: /media/Data/xCNC-Logic/recovering.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/4a6d875c
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4a6d875c/recovering.o /media/Data/xCNC-Logic/recovering.cpp

${OBJECTDIR}/_ext/4a6d875c/safety.o: /media/Data/xCNC-Logic/safety.c
	${MKDIR} -p ${OBJECTDIR}/_ext/4a6d875c
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4a6d875c/safety.o /media/Data/xCNC-Logic/safety.c

${OBJECTDIR}/_ext/4a6d875c/ui-io.o: /media/Data/xCNC-Logic/ui-io.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/4a6d875c
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4a6d875c/ui-io.o /media/Data/xCNC-Logic/ui-io.cpp
